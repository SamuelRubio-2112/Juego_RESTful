...
//GET /api/personajes
exports.getAllPersonajes = async (req, res, next) => {
    try {
...
exports.getPersonajeById = async (req, res, next) => {
    try {
...
exports.putPersonajeById = async (req, res, next) => {
  try {
    const id = req.params.id;
...
exports.postHabilidadInPersonaje = async (req, res, next) => {
  try {
...
exports.deletePersonajeById = async (req, res, next) => {
  try {
    const id = req.params.id;
    const personaje = await Personaje.findByPk(id);
